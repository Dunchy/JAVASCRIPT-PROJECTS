...
function checkGuess(){
    ...
    if (guess == rngNumber){
        document.getElementById("result").innerHTML = "OH MY GOD YOU GOT IT EXACTLY RIGHT. YOU WIN!!!"} //In the unlikely event that the user guesses the exact right number they get this message
        ...
        document.getElementById("result").innerHTML = "You win! you guess was " + Math.abs(guess - rngNumber) + " away from the number"} // If the user guesses within 10 of the random number they get this message
    else{
        document.getElementById("result").innerHTML = "You lose! You were " + Math.abs(guess - rngNumber) + " away from the number"} // This will show the user how far they were away from the random number if they lose
}
